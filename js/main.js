...
{/*var data='{"labels": ['+
    ...
    '{"id": "Label_5","name": "Junk","type": "user"},'+
    '{"id": "CATEGORY_FORUMS","name": "CATEGORY_FORUMS","type": "system"},'+
    '{"id": "Label_2","name": "Receipts","messageListVisibility": "hide","labelListVisibility": "labelHide","type": "user"},'+
    '{"id": "Label_4","name": "Work","messageListVisibility": "hide","labelListVisibility": "labelHide","type": "user"},'+
...
{
    if(json.labels[i].type=="system")
    {
        var jsonObj={"id":[json.labels[i].id],"name":[json.labels[i].name]};
        output.push(jsonObj);
    }
}
